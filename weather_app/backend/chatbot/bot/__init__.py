            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    'fields': {
                        ...
                        'description': 'The weather data fields that you will recieve. By Defual, all feilds are set. Based on the users request, slect data feilds to reduce the amount of tokens needed.'
