...
ALLOWED_HOSTS = [socket.gethostbyname(socket.gethostname()), '127.0.0.1', 'localhost', '192.168.0.178']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'contact.webgenieai@gmail.com'
EMAIL_HOST_PASSWORD = 'NathanP2305'
